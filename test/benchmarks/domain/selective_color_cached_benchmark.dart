...
const _resultsPath = 'selective_color_cached_benchmark_results.json';

void main() {
  test('selective color cached prep benchmark (host)', () async {
    final bytes = await _loadOrGenerateFixture();
    final results = runSelectiveColorPrepCacheBenchmark(
      fixtureBytes: bytes,
    ...
    printResults('Selective color cached prep benchmark (host)', results);
