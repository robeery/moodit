...
const _resultsPath = 'basic_operation_benchmark_results.json';

void main() {
  test('individual basic operation benchmark (host)', () async {
    ...
    printResults('Individual basic operation benchmark (host)', results);
